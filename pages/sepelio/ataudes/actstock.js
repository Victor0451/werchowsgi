...
export default function actStock() {
    ...
    if (router.query.idataud) {
        jsCookie.set("idataud", router.query.idataud)
    }
    ...
    const regHistorialAtaud = async () => {
        ...
        await axios
            .post(`/api/sepelio/ataudes`, historial)
    };
    ...
    const actStockAtaud = async () => {
        ...
        if (fechaRecRef.current.value === "") {
            ...
            guardarErrores("Debes ingresar el N° de Remito, en caso de no tenerlo ingresa 0")
                ...
                buttons: [
                    {
                        ...
                        onClick: () => {
                            ...
                            axios.put(`/api/sepelio/ataudes`, stck)
                                .then(res => {

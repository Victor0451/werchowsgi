...
export default function nuevoservicio() {
    ...
    const traerAdhs = async (f, contrato) => {
        ...
        console.log(f, contrato);

        await axios.get(`/api/socios`, {
            params: {
                f: f,
                contrato: contrato
            }
            ...
            .catch(error => {
                console.log(error);
                toast.error("Orcurrio un error al traer el listado de adherentes de la ficha")
            })
            ...
            await axios.get('/api/sepelio/servicios', {
                ...
                .then(res => {
                    ...
                    if (res.data.length > 0) {
                        ...
                        guardarAlertas("El DNI ingresado pertenece a un servicio registrado")
                        ...
                        axios.get('/api/socios', {
                            ...
                            .then(res0 => {
                                ...
                                if (re.length > 0) {
                                    ...
                                    axios.get('/api/socios', {
                                        ...
                                        .then(res1 => {
                                            ...
                                            if (re.length > 0) {
                                                ...
                                                axios.get('/api/socios', {
                                                        ...
                                                        if (re.length > 0) {
                                                            ...
                                                            axios.get('/api/socios', {
                                                                ...
                                                                if (re.length > 0) {
                                                                    ...
                                                                    toast.info("El DNI ingresado no se encuentra registrado")
                                                                    guardarAlertas("El DNI ingresado no se encuentra registrado")
                                                                ...
                                                                .catch(error => {
                                                                    console.log(error)
                                                                    toast.error("Ocurrio un error al tarer los datos del difunto en adherente mutual")
                                                                })
                                                    ...
                                                    .catch(error => {
                                                        console.log(error)
                                                        toast.error("Ocurrio un error al tarer los datos del difunto en mutual")
                                                    })
                                        ...
                                        .catch(error => {
                                            console.log(error)
                                            toast.error("Ocurrio un error al tarer los datos del difunto en adherentes")
                                        })
                            ...
                            .catch(error => {
                                console.log(error)
                                toast.error("Ocurrio un error al tarer los datos del difunto en maestro")
                            })
                ...
                .catch(error => {
                    console.log(error)
                    toast.error("Ocurrio un error al tarer los datos del difunto en servicios")
                })
    ...
    const updateStockAtaud = async () => {
        ...
        await axios.put('/api/sepelio/ataudes', stock)
            .then(res => {
                if (res.status === 200) {
    ...
    const asigParcelaServ = async (id, servicio) => {
        ...
        await axios.put(`/api/sepelio/parcelas`, parce)
            .then(res => {
                if (res.status === 200) {
    ...
    const regServicio = async () => {
        ...
        if (servicio.dni === "") {
            ...
            guardarErrores("Debes ingresar el cementerio en donde se realizara la inhumacion")
            ...
            guardarErrores("Debes ingresar el apellido y nombre del solicitante del servicio")
            ...
            guardarErrores("Debes seleccionar el parentezco del solicitante con respecto al difunto")
            ...
            await axios.post(`/api/sepelio/servicios`, servicio)
                .then(res => {
    ...
    const traerDatos = async () => {
        ...
        await axios.get(`/api/sepelio/parcelas`, {
            params: {
                f: "list parcelas"
            }
        })

...
import FormCalendar from "@/components/sepelio/tareas/FormCalendar";
...
function calendario(props) {
  ...
  const postEvent = async () => {
    ...
    if (tareaSel === "") {
      ...
      toast.info("Debes seleccionar el operador");
    } else if (prioSel === "") {
  ...
  useSWR("/api/sepelio/tareas", getEvents);

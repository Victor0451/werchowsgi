...
console.log(gasto)
        ...
        if (gasto.empresa === "") {
            ...
            guardarErrores("Debes seleccionar la empresa a la que se imputara el gasto")
            ...
            guardarErrores("Debes seleccionar el servicio al cual esta relacionada la caja")
                        ...
                        if (listado.length === 0) {
                            ...
                            for (let i = 0; i < listado.length; i++) {
                                ...
                                axios
                                    ...
                                    .then((res) => {
                                        if (res.status === 200) {
                                            toast.success(`El gasto ${listado[i].concepto} por un monto de ${listado[i].total} se registro correctamente`);

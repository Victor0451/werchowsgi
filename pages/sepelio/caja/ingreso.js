...
export default function Ingreso() {
    ...
    const handleChange = (flag, value) => {impresión
        impresión
    ...
    const nuevoIngreso = () => {
        ...
        if (ingreso.empresa === "") {
            ...
            guardarErrores("Debes seleccionar la empresa a la que se imputara el ingreso")
        ...
        confirmAlert({
            ...
            buttons: [
                ...
                },
                {
                    label: "No",
                    onClick: () => {
                        toast.info("La caja sigue abierta, puedes seguir registrando gastos")
                    },
                },
            ],
        });
                        ...
                        if (listado.length === 0) {
                            ...
                            for (let i = 0; i < listado.length; i++) {
                                ...
                                axios
                                    ...
                                    .then((res) => {
                                        if (res.status === 200) {
                                            toast.success(`El ingreso ${listado[i].concepto} por un monto de ${listado[i].total} se registro correctamente`);
                                ...
                                confirmAlert({
                                    ...
                                    buttons: [
                                        ...
                                        },
                                        {
                                            label: "No",
                                            onClick: () => {
                                                toast.info("La caja sigue abierta, puedes seguir registrando ingresos")
                                            },
                                        },
                                    ],
                                });

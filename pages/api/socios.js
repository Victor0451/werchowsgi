...
export default async function handler(req, res) {
    ...
    `
            ...
            res.status(200).json(JSON.stringify(mae, (key, value) =>
    ...
    `
            ...
            res.status(200).json(JSON.stringify(adh, (key, value) =>
                typeof value === 'bigint' ? (value.toString()) : (value),
            ))
            ...
            res.status(200).json(JSON.stringify(mut, (key, value) =>
                typeof value === 'bigint' ? (value.toString()) : (value),
            ))
    ...
    `
            ...
            res.status(200).json(JSON.stringify(mutAdh, (key, value) =>
                typeof value === 'bigint' ? (value.toString()) : (value),
            ))
    ...
    `
            ...
            res.status(200).json(JSON.stringify(maeAdh, (key, value) =>
                typeof value === 'bigint' ? (value.toString()) : (value),
            ))

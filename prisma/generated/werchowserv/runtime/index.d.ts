...
export declare type DynamicClientExtensionThis<TypeMap extends TypeMapDef, TypeMapCb extends TypeMapCbDef, ExtArgs extends Record<string, any>> = {
    ...
    [P in Exclude<keyof TypeMap['other']['operations'], keyof ExtArgs['client']>]: <R = GetResult_2<TypeMap['other']['operations'][P]['payload'], any, P & Operation>>(...args: ToTuple<TypeMap['other']['operations'][P]['args']>) => PrismaPromise<R>;
} & {
...
export declare type DynamicModelExtensionThis<TypeMap extends TypeMapDef, M extends PropertyKey, ExtArgs extends Record<string, any>> = {
    ...
    [P in Exclude<keyof TypeMap['model'][M]['operations'], keyof ExtArgs['model'][Uncapitalize<M & string>]>]: {} extends TypeMap['model'][M]['operations'][P]['args'] ? <A extends TypeMap['model'][M][P]['args']>(args?: A) => PrismaPromise<GetResult_2<TypeMap['model'][M]['operations'][P]['payload'], A, P & Operation>> : <A extends TypeMap['model'][M]['operations'][P]['args']>(args: A) => PrismaPromise<GetResult_2<TypeMap['model'][M]['operations'][P]['payload'], A, P & Operation>>;
} & {
...
export declare type DynamicResultExtensionData<TypeMap extends TypeMapDef, M extends PropertyKey, S> = GetFindResult<TypeMap['model'][M]['operations']['findFirstOrThrow']['payload'], {
    select: S;
}>;
...
} ? T[symbol]['types']['operations'][F]['payload'] : never;
...
} ? GetResult_2<T[symbol]['types']['operations'][F]['payload'], A, F> : never;
...
declare type UnwrapPayload<P> = {
    [K in keyof P]: P[K] extends Payload[] ? UnwrapPayload<P[K]> : P[K] extends Payload ? P[K]['scalars'] & UnwrapPayload<P[K]['composites']> : P[K] extends (infer O extends Payload) | null ? (O['scalars'] & UnwrapPayload<O['composites']>) | null : P[K];
} & unknown;

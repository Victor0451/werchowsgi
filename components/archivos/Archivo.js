...
import { ArrowDownCircleIcon, TrashIcon, EyeIcon } from "@heroicons/react/24/solid";
                    ...
                    <div className="grid md:grid-cols-3 md:gap-6">
                        ...
                        <div>
                            <Link href={`${ip}${urlDesc}${archivo}`} >
                                <ArrowDownCircleIcon color='green' className="butlist mt-px h-6 w-6" />
                            </Link>
                        </div>

                        <div>
                            <TrashIcon color='red' className="butlist mt-px h-6 w-6" onClick={() => { eliminarArchivos(archivo) }} />
                        </div>

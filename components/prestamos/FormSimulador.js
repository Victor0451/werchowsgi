        ...
        >
          ...
          <Typography color="white" className="mt-2 font-normal ">
            <p className=" text-justify">
              ESTE ES UN SIMULADOR QUE PERMITE REALIZAR EL CALCULO DE LOS
              VALORES DE UN SUBSIDIO DE MANERA PRACTICA Y FACIL, CON FINES
              INFORMATIVOS PARA EL SOCIO, SIN LA OBLIGACION DE TENER QUE
              CREARLO. EN CASO DE QUERER CONFECCIONAR UN SUBSIDIO, PUEDES HACER{" "}
              <Link className="" href={"/prestamos/nuevoprestamo"}>
                <strong>
                  <u>CLICK AQUI</u>
                </strong>
              </Link>

...
import { CheckCircleIcon, XCircleIcon, PrinterIcon, FolderIcon, ArrowUpCircleIcon } from "@heroicons/react/24/solid";
import { Spinner } from "@material-tailwind/react";
import moment from 'moment';
import Link from 'next/link';


export const ListadoPrestamos = ({
    listado,
    usu,
    estadoPrest
}) => {
                            ...
                            <>

                                {
                                    row.ptm_estado === "PENDIENTE" ? (
                                        <>
                                            <CheckCircleIcon color='green' className="butlist mt-px h-6 w-6 " onClick={() => estadoPrest('A', row.ptm_id)} />

                                            <XCircleIcon color='red' className="butlist mt-px h-6 w-6 " onClick={() => estadoPrest('R', row.ptm_id)} />
                                        </>
                                    ) : null
                                }

      ...
      <CardHeader floated={false} shadow={false} className="rounded-none">
        ...
        <div className="border-2 rounded-xl p-4 mt-5">
          ...
          >
            ...
            <Typography color="white" className="mt-2 font-normal ">
              <p className=" text-justify">
                EN ESTE MODULO SE PUEDEN REGISTRAR LAS SOLICITUDES DE PRESTAMOS
                DISPONIBLES SOLO PARA EMPLEADOS DE WERCHOW..
              </p>
            </Typography>
          </Alert>
          ...
          <div className=" p-4 grid gap-6 mb-6 md:grid-cols-4">
            ...
            <div className="mt-2">
              <Button onClick={simularPrestamo}>Calcular Prestamo</Button>
            </div>
          </div>
          ...
          <>
            ...
            <div className=" p-4 grid gap-6 mb-6 md:grid-cols-1">
              ...
              <div className=" flex justify-end">
                <Button onClick={registrarPrestamo}>Registrar Prestamo</Button>
              </div>
            </div>
          </>
        ) : null}

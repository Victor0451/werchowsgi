      ...
      <CardHeader floated={false} shadow={false} className="rounded-none">
        ...
        <div className="p-4 border-2 rounded-lg mt-6">
          ...
          <div className="grid md:grid-cols-3 md:gap-6">
            ...
            <div className="relative z-0 w-full mb-6 group">
              <Button onClick={buscarPeriodo}>Buscar</Button>
            </div>
          </div>
          {errores ? (
            <Alert
          ...
          <>
            <div className="p-4 border-2 rounded-lg mt-6">
              ...
              <Typography color="gray" className="mt-1 font-normal">
                <u>Total</u>: {listPrest.length}
              </Typography>
              <Typography color="gray" className="mt-1 font-normal">
                <u>Total Capital</u>: ${totalPrestamo(listPrest, "c")}
              </Typography>
              <Typography color="gray" className="mt-1 font-normal">
                <u>Total Capital + Intereses</u>: $
                {totalPrestamo(listPrest, "c+i")}
              </Typography>
              ...
              <ListadoReporte listado={reportes} f={"rep op"} />
            </div>
            ...
            <div className="p-4 border-2 rounded-lg mt-6">
              ...
              <ListadoReporte listado={listPrest} usu={usu} f={"rep prest"} />
            </div>
          </>
        ) : null}
      </CardHeader>

        ...
        <div className=" mt-4 grid gap-6 mb-6 md:grid-cols-5">
          <div>
            <Badge content={`${CasaCentralMG.length}`} withBorder>
              <Tooltip content="Asignar Campaña" placement="bottom-start">
                <Button
                  onClick={() => crearCampana(CasaCentralMG, camp, "mgalian")}
                >
                  Campaña: Maria
                </Button>
              </Tooltip>
          ...
          <div>
            <Badge content={`${CasaCentralGG.length}`} withBorder>
              <Tooltip content="Asignar Campaña" placement="bottom-start">
                <Button
                  onClick={() => crearCampana(CasaCentralGG, camp, "ladorno")}
                >
                  Campaña: Lucia
                </Button>
              </Tooltip>
          ...
          <div>
            <Badge content={`${palpala.length}`} withBorder>
              <Tooltip content="Asignar Campaña" placement="bottom-start">
                <Button onClick={() => crearCampana(palpala, camp, "palpala")}>
                  Campaña: Palpala
                </Button>
              </Tooltip>
            </Badge>
          ...
          <div>
            <Badge content={`${perico.length}`} withBorder>
              <Tooltip content="Asignar Campaña" placement="bottom-start">
                <Button onClick={() => crearCampana(perico, camp, "perico")}>
                  Campaña: Perico
                </Button>
              </Tooltip>
            </Badge>
          ...
          <div>
            <Badge content={`${sanPedro.length}`} withBorder>
              <Tooltip content="Asignar Campaña" placement="bottom-start">
                <Button
                  onClick={() => crearCampana(sanPedro, camp, "sanpedro")}
                >
                  Campaña: San Pedro
                </Button>
              </Tooltip>

            ...
            <CardBody>
                <div id="caja" className='p-2' ref={(el) => (componentRef = el)}>
                    <div className='border-2 rounded-xl p-4'>
                        <Typography variant="h4" className="mt-2" >Caja N°: {caja.idcaja}</Typography>
                        <Typography variant="h6" className="mt-2">Habilitacion Monto: ${caja.monto - totales(ingresos, "i")}</Typography>
                        <Typography variant="h6" className="mt-2">Fecha: {moment(caja.fecha).format('DD/MM/YYYY')}</Typography>
                        <Typography variant="h6" className="mt-2">Cierre: {moment(caja.cierre).format('DD/MM/YYYY')}</Typography>

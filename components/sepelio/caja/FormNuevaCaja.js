                ...
                <div className='p-4 border-2 rounded-lg mt-6 '>
                    ...
                    <div className="grid md:grid-cols-3 md:gap-6">
                        ...
                        <div className="relative z-0 w-full mb-6 group">
                            <Input size="md" label="Monto" type="number" inputRef={montoRef} />
                        ...
                        <div className="relative z-0 w-full mb-6 group">
                            <Input size="md" label="N° Factura" type="text" inputRef={nfacturaRef} defaultValue={0} />

                        </div>

                        <div className="relative z-0 w-full mb-6 group">
                            <Input size="md" label="Pto. Venta" type="number" inputRef={ptoVentaRef} defaultValue={0} />

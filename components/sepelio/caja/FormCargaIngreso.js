                ...
                <>
                    {
                        usu.perfil === 1 || usu.perfil === 3 || usu.perfil === 4 ? (
                            <>
                                ...
                                <TrashIcon color='red' className="butlist mt-px h-6 w-6" onClick={() => { eliminarIngreso(index) }} />
...

                {
                    caja.estado === true ? (
                        ...
                        <div className="relative w-full mb-6 group mt-5 ">
                            ...
                            >
                                <strong> La caja esta abierta</strong> <Button className='ml-5' onClick={cerrarCaja} >Cerrar Caja</Button>
                            </Alert>
                        </div>
                ...
                <div className='p-4 border-2 rounded-lg mt-6 '>
...

                    {
                        caja.estado === false ? (
                            ...
                            >
                                <strong>Caja cerrada: no puedes realizar ningun movimiento</strong>
                            </Alert>
                        ) : (
